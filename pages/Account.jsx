...
const Account = () => {
    ...
    return (
      <>
        ...
        <button className='flex items-center justify-center p-3 bg-orange-600 border border-orange-600 my-2' onClick={() => signIn()}><FaGoogle className="mr-2" />Sign in with <span className='font-bold pl-1'>Google</span></button>
        </div>
